...
import { getCourseBySlug, modulesByCourse } from "@/lib/demo-data";
      ...
      <section className="overflow-hidden rounded-[1.7rem] p-6 text-white sm:p-8" style={{ background: course.accent }}>
        <div className="grid gap-8 lg:grid-cols-[1.3fr_0.7fr] lg:items-end">
          <div>
            ...
            <a href={`/aluno/aulas/${course.nextLessonId}`} className="btn-primary mt-6 w-full sm:w-auto"><Play size={19} fill="currentColor" /> Continuar curso</a>
          </div>
